...
for country in countries:
    ...
    dates_ba1 = list(counts[pango2flupredict['BA.1']].keys()) #ADD BA.1.1
    dates_ba11 = list(counts[pango2flupredict['BA.1.1']].keys()) #ADD BA.1.1
    ...
    dates_ba1 = [a for a in dates_ba1 if a < 44773 and a > Time.dateToCoordinate("2021-12-01")]
    dates_ba11 = [a for a in dates_ba11 if a < 44773 and a > Time.dateToCoordinate("2021-12-01")]
    dates_ba2 = [a for a in dates_ba2 if a < 44773 and a > Time.dateToCoordinate("2021-12-01")] #before 2022-08-01
    if country == 'NY' or country == 'USA':
        dates_ba2 = [a for a in dates_ba2 if a < 44773 and a > 44534] #before 2022-08-01
